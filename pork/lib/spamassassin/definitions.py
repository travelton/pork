...
definitions = {
    ...
    "AWL": "From: address is in the auto white-list (http://wiki.apache.org/spamassassin/AutoWhitelist)",
    ...
    "HELO_LH_LD": "Poorly configured server. Helo is localhost.",
    ...
    "MULTIPART_ALT_NON_TEXT": "eval:check_ma_non_text()",
    ...
    "RCVD_IN_BRBL_LASTEXT": "Last external relay in Received chain in BRBL DNSBL",
    "RCVD_IN_BSP_OTHER": "Sender is in Bonded Sender Program (other relay)",
    "RCVD_IN_BSP_TRUSTED": "Sender is in Sender Score Certified (trusted relay)",
    ...
    "RCVD_IN_MAPS_DUL": "Relay in RBL, www.mail-abuse.org/rbl/",
    "RCVD_IN_MAPS_NML": "Relay in NML, www.mail-abuse.org/nbl/",
    "RCVD_IN_MAPS_RBL": "Relay in RBL, www.mail-abuse.org/rbl/",
    "RCVD_IN_MAPS_RSS": "Relay in RSS, www.mail-abuse.org/rss/",
    ...
    "RCVD_IN_SORBS_WEB": "SORBS: sender is an abuseable web server",
    ...
    "TT_MSGID_TRUNC": "Unknown",
    "TVD_ACT_193": "Unknown",
    "TVD_APPROVED": "Body contains 'you're approved'",
    "TVD_FINGER_02": "Body contains invalid Content-Type and additional properties that appear spammy",
    ...
    "URIBL_BLACK": "[Body] Contains an URL listed in the URIBL blacklist",
    "URIBL_BLOCKED": "URIBL lookup throttled or blocked",
    ...
    "URIBL_RHS_BOGUSMX": "Contains an URI listed in bogusmx.rfc-ignorant.org",
    "URIBL_RHS_DOB": "Contains an URI of a new domain (Day Old Bread) ",
    "URIBL_RHS_DSN": "Contains an URI listed in dsn.rfc-ignorant.org ",
    "URIBL_RHS_POST": "Contains an URI listed in postmaster.rfc-ignorant.org",
    "URIBL_RHS_TLD_WHOIS": "Contains an URI TLD listed in whois.rfc-ignorant.org",
    "URIBL_RHS_WHOIS": "Contains an URI listed in whois.rfc-ignorant.org",
